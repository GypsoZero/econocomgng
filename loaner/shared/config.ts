...
export const PROD = 'grab-n-go-242608';

/** The url for the Google Cloud Endpoints API for your application. */
export const WEB_CLIENT_IDS: EnvironmentsVariable = {
  prod: `215454144414-pu5sq27mtlfi683ncohsfncaedlrq66a.apps.googleusercontent.com`,
  qa: `{QA_WEB_ID}`,
  dev: `{DEV_WEB_ID}`,
};
...
export const CHROME_PUBLIC_KEYS: EnvironmentsVariable = {
  prod: '',
  qa: '{QA_CHROME_KEY}',
  dev: '{DEV_CHROME_KEY}',
};
