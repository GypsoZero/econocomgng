...
ON_PROD = ON_GAE and ('grab-n-go-242608' in APPLICATION_ID)
...
ADMIN_EMAIL = 'joshua.willybiro@econocom.com'

# The email address application emails will come from.
SEND_EMAIL_AS = 'no-reply@econocom.com'
...
SUPERADMINS_GROUP = 'technical-admins@econocom.com'
